# __report-core__
[![CI](https://img.shields.io/github/actions/workflow/status/stalexsm/report_core/ci.yml?branch=main&logo=github&label=CI)](https://github.com/stalexsm/report_core/actions?query=event:push+branch:main+workflow:CI)
